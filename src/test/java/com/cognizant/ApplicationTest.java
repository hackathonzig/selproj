...
public class ApplicationTest extends Zig{
	...
	//Below are 4 functions with assigned priorities which is used for logging in as a user in the page.
	//But going on ahead the page logs out the user automatically when we move and execute the test cases.
	//And when tried to login again it shows an error by the website itself thus hindering the execution the test cases.
	//That is why the below part is commented out , otherwise the login is happening and we can login as the user so the 
	// below 4 test cases work fine but pose a problem going on ahead due to website issues.
	...
	public void setEmail() throws InterruptedException {
		...
		for (String newwindow1 : windows2) {
			Thread.sleep(3000);
	...
	public void selectNext2() throws InterruptedException {
		...
		Thread.sleep(10000);
		//driver.findElement(By.xpath("//*[@id=\"ot_s_md\"]/div[1]/div[2]")).click();

		//driver.findElement(By.xpath("//*[@id=\"ot_s_md\"]/div[2]/div[5]/a[1]")).click();
		//Thread.sleep(8000);
		//driver.findElement(By.xpath("//*[@id=\"ot_s_md\"]/div[3]/div[2]")).click();
		//Thread.sleep(8000);
		driver.findElement(By.xpath("//*[@id=\"ask_user_mobile\"]/div[2]")).click();
		Thread.sleep(10000);
	}*/
	@Test(priority = 8)
	public void newBikes() throws InterruptedException {
		...
		driver.navigate().to("https://www.zigwheels.com/");
		Thread.sleep(8000);
		//driver.findElement(By.xpath("//*[@id=\"close\"]/svg")).click();
		//Thread.sleep(8000);
		//WebElement target = driver.findElement(By.xpath("//a[@data-track-component='navigation' and @href='/newbikes' ]"));
		WebElement target=driver.findElement(By.xpath("//*[@id=\"headerNewNavWrap\"]/div[2]/ul/li[3]/a"));
